...
def get_top_words(file_path):
    ...
    # Introduce a bug: Do not convert common words to uppercase before filtering
    words = [word for word in cleaned_text.split() if word not in common_words]  # Bug here
...
# List of text files (adjust paths if needed)
file_paths = [
